...
if __name__ == "__main__":
    my_ftp = MyFTP("192.168.8.203")
    my_ftp.login("root", "linux")
    ...
    # 上传单个文件
    mm =my_ftp.upload_file("C:\\Users\Administrator\Desktop\\notfit\lysvr111", "/tmp/work/backup/lysvr222")
    print(mm)

    # 上传目录
    # my_ftp.upload_file_tree("C:\\Users\\Administrator\\Desktop\\notfit\\", "\\tmp\\work\\backup\\test_ly\\")
